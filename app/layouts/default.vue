...
<template>
  ...
  <div v-else class="min-h-screen bg-neutral-50 text-neutral-950">
    <div class="flex min-h-screen">
      ...
      <aside
        class="fixed inset-y-0 left-0 z-50 flex w-[290px] max-w-[85vw] flex-col border-r border-neutral-200 bg-white transition-transform duration-200 lg:sticky lg:top-0 lg:z-30 lg:w-[280px] lg:max-w-none lg:translate-x-0"
      ...
      >
        ...
        <div class="border-t border-neutral-200 p-4">
          <div class="rounded-[24px] bg-neutral-50 p-4">
            <p class="text-sm font-semibold text-neutral-950">AutoParts KRG</p>
