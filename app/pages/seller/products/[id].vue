...
useSeoMeta({
  ...
  description: 'Редактирование товара в кабинете продавца.',
})
...
const products: SellerProduct[] = [
  {
    ...
    description:
      'Передние тормозные колодки для Toyota Camry 55. Подходят для повседневной эксплуатации, обеспечивают стабильное торможение и хороший ресурс.',
    images: [
      {
        id: 1,
    ...
    specs: [
      { id: 1, label: 'Категория', value: 'Тормозная система' },
      { id: 2, label: 'Бренд авто', value: 'Toyota' },
      { id: 3, label: 'Модель', value: 'Camry 55' },
      { id: 4, label: 'Поколение', value: '2014–2017' },
      { id: 5, label: 'Двигатель', value: '2.5' },
      { id: 6, label: 'Производитель детали', value: 'Akebono' },
      { id: 7, label: 'Артикул', value: 'AKE-04465' },
      { id: 8, label: 'Город', value: 'Караганда' },
    ],
  },
]

const productId = computed(() => Number(route.params.id))
const sourceProduct = computed(() => products.find((item) => item.id === productId.value) ?? null)

const form = ref<SellerProduct | null>(null)
...
watchEffect(() => {
  ...
  form.value = JSON.parse(JSON.stringify(sourceProduct.value)) as SellerProduct
          ...
          <div class="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            <div>
              ...
              <p class="mt-3 max-w-2xl text-sm leading-6 text-white/70 sm:text-base">
                Изменяй данные товара, описание, характеристики, цену и остаток в одной странице.
              </p>
            </div>
                ...
                <div class="p-4 sm:p-6">
                  <div class="overflow-hidden rounded-[24px] border border-neutral-200 bg-white">
                    <div class="relative aspect-[4/3] bg-neutral-100">
                      <img :src="activeImage" :alt="form.name" class="h-full w-full object-cover" />
            ...
            <div class="rounded-[28px] border border-neutral-200 bg-white p-5 shadow-sm">
              ...
              <div class="mt-4 space-y-3">
                ...
                <div class="rounded-2xl bg-neutral-50 px-4 py-4">
                  ...
                  <p class="mt-2 text-lg font-semibold text-neutral-950">{{ form.stock }} шт.</p>
                </div>
                ...
                <div class="rounded-2xl bg-neutral-50 px-4 py-4">
                  <p class="text-xs uppercase tracking-[0.18em] text-neutral-400">Обновлено</p>
